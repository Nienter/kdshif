        ...
        while (i7 < childCount) {
            ...
            if (childAt != view) {
                if (childAt.getVisibility() != 8) {
                    int max = Math.max(isLayoutRtlSupport ? width : width2, childAt.getLeft());
                    ...
                    int min = Math.min(i5, childAt.getRight());
            ...
            if ((isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) <= 0) {
                ...
                for (i = 0; i < childCount; i++) {
                    ...
                    if (childAt != this.mSlideableView) {
                        ...
                        int i2 = ((int) ((1.0f - this.mParallaxOffset) * ((float) this.mParallaxBy))) - ((int) ((1.0f - f) * ((float) this.mParallaxBy)));
                        if (isLayoutRtlSupport) {
                            i2 = -i2;
                        }
