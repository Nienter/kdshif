...
class NotificationCompatIceCreamSandwich {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor {
        ...
        public Notification build() {
            return this.f77b.getNotification();
        }
    }
