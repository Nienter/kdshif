...
class VisibilityKitKat extends TransitionKitKat implements VisibilityImpl {
    ...
    public boolean isVisible(TransitionValues transitionValues) {
        return ((Visibility) this.mTransition).isVisible(convertToPlatform(transitionValues));
    }

    public Animator onAppear(ViewGroup viewGroup, TransitionValues transitionValues, int i, TransitionValues transitionValues2, int i2) {
        return ((Visibility) this.mTransition).onAppear(viewGroup, convertToPlatform(transitionValues), i, convertToPlatform(transitionValues2), i2);
    }

    public Animator onDisappear(ViewGroup viewGroup, TransitionValues transitionValues, int i, TransitionValues transitionValues2, int i2) {
        return ((Visibility) this.mTransition).onDisappear(viewGroup, convertToPlatform(transitionValues), i, convertToPlatform(transitionValues2), i2);
    }
}
