...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f87C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f88C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f89C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f90J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double d3 = (-d2) / 360.0d;
        double sin2 = (Math.sin((double) f2) * 0.0053d) + d3 + ((double) (((float) Math.round(((double) (f - f90J0)) - d3)) + f90J0)) + (-0.0069d * Math.sin(2.0d * sin));
