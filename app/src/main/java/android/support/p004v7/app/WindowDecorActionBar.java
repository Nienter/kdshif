...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0309R.C0311id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0309R.C0311id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0309R.C0311id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0309R.C0311id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0309R.styleable.ActionBar, C0309R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0309R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0309R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0309R.attr.actionBarWidgetTheme, typedValue, true);
