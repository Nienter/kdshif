...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, MenuBuilder.Callback {
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0309R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0309R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0309R.C0312style.Theme_AppCompat_CompactMenu, true);
            }
            ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0309R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0309R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0309R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0309R.layout.abc_list_menu_item_layout);
    ...
    private ViewGroup createSubDecor() {
        ...
        Context context;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0309R.styleable.AppCompatTheme);
        if (!obtainStyledAttributes.hasValue(C0309R.styleable.AppCompatTheme_windowActionBar)) {
            obtainStyledAttributes.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (obtainStyledAttributes.getBoolean(C0309R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (obtainStyledAttributes.getBoolean(C0309R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (obtainStyledAttributes.getBoolean(C0309R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (obtainStyledAttributes.getBoolean(C0309R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = obtainStyledAttributes.getBoolean(C0309R.styleable.AppCompatTheme_android_windowIsFloating, false);
        obtainStyledAttributes.recycle();
        this.mWindow.getDecorView();
        LayoutInflater from = LayoutInflater.from(this.mContext);
        if (this.mWindowNoTitle) {
            if (this.mOverlayActionMode) {
                viewGroup = (ViewGroup) from.inflate(C0309R.layout.abc_screen_simple_overlay_action_mode, null);
            } else {
                viewGroup = (ViewGroup) from.inflate(C0309R.layout.abc_screen_simple, null);
            }
            ...
            viewGroup2 = (ViewGroup) from.inflate(C0309R.layout.abc_dialog_title_material, null);
        } else if (this.mHasActionBar) {
            TypedValue typedValue = new TypedValue();
            this.mContext.getTheme().resolveAttribute(C0309R.attr.actionBarTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                context = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
            } else {
                context = this.mContext;
            }
            ViewGroup viewGroup3 = (ViewGroup) LayoutInflater.from(context).inflate(C0309R.layout.abc_screen_toolbar, null);
            this.mDecorContentParent = (DecorContentParent) viewGroup3.findViewById(C0309R.C0311id.decor_content_parent);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) viewGroup2.findViewById(C0309R.C0311id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(viewGroup2);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup2.findViewById(C0309R.C0311id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0309R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0309R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0309R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0309R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0309R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0309R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0309R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0309R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0309R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0309R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0309R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
        ...
        if (actionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    theme.resolveAttribute(C0309R.attr.actionBarTheme, typedValue, true);
                    if (typedValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(context, null, C0309R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    context.getTheme().resolveAttribute(C0309R.attr.actionBarSize, typedValue, true);
                    ...
                    ViewStubCompat viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(C0309R.C0311id.action_mode_bar_stub);
    ...
    public View callActivityOnCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        if (this.mOriginalWindowCallback instanceof LayoutInflater.Factory) {
            View onCreateView = ((LayoutInflater.Factory) this.mOriginalWindowCallback).onCreateView(str, context, attributeSet);
        ...
        if (!panelFeatureState.isOpen && !isDestroyed()) {
            ...
            if (windowCallback == null || windowCallback.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
                    ...
                    WindowManager.LayoutParams layoutParams4 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f85x, panelFeatureState.f86y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (typedValue.resourceId != 0) {
                ...
                theme2.resolveAttribute(C0309R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0309R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context2.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0309R.color.abc_input_method_navigation_guard));
