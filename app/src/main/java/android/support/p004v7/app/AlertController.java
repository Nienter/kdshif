...
class AlertController {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0309R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0309R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0309R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0309R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0309R.styleable.AlertDialog, C0309R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0309R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0309R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0309R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0309R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0309R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0309R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0309R.styleable.AlertDialog_showTitle, true);
    ...
    private void setupView() {
        ...
        boolean z2;
        int i;
        View findViewById = this.mWindow.findViewById(C0309R.C0311id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0309R.C0311id.topPanel);
        View findViewById3 = findViewById.findViewById(C0309R.C0311id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0309R.C0311id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0309R.C0311id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0309R.C0311id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0309R.C0311id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0309R.C0311id.buttonPanel);
        ...
        if (!z2 && resolvePanel2 != null) {
            View findViewById8 = resolvePanel2.findViewById(C0309R.C0311id.textSpacerNoButtons);
        ...
        if (z) {
            ...
            if (!(this.mMessage == null && this.mListView == null && !z3) && !z3) {
                view = resolvePanel.findViewById(C0309R.C0311id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            View findViewById9 = resolvePanel2.findViewById(C0309R.C0311id.textSpacerNoTitle);
        ...
        if (!z3) {
            ...
            if (viewGroup2 != null) {
                ...
                setScrollIndicators(resolvePanel2, viewGroup2, (z2 ? 2 : 0) | i, 3);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        final View findViewById = this.mWindow.findViewById(C0309R.C0311id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0309R.C0311id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0309R.C0311id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0309R.C0311id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0309R.C0311id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0309R.C0311id.scrollView);
