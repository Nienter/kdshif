...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (!(i2 == 0 && i9 == 0)) {
                            ...
                            if (i2 == currX) {
                                i3 = i2 < 0 ? -currVelocity : i2 > 0 ? currVelocity : 0;
                            } else {
                                i3 = 0;
                            }
                            if (i9 != currY) {
                            ...
                            if ((i3 != 0 || i2 == currX || scrollerCompat.getFinalX() == 0) && (currVelocity != 0 || i9 == currY || scrollerCompat.getFinalY() == 0)) {
                                scrollerCompat.abortAnimation();
                            }
                        }
                        if (!(i6 == 0 && i == 0)) {
                            RecyclerView.this.dispatchOnScrolled(i6, i);
                        }
                        if (!RecyclerView.this.awakenScrollBars()) {
                            RecyclerView.this.invalidate();
                        }
                        boolean z = (i4 != 0 && i5 == 0) || (i4 == 0 && RecyclerView.this.mLayout.canScrollHorizontally() && i6 == i4) || (i5 == 0 && RecyclerView.this.mLayout.canScrollVertically() && i == i5);
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0315R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0315R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0315R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
