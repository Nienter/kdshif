...
class ItemTouchUIUtilImpl {
    ...
    static class Lollipop extends Honeycomb {
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, View view, float f, float f2, int i, boolean z) {
            if (z && view.getTag(C0315R.C0316id.item_touch_helper_previous_elevation) == null) {
                Float valueOf = Float.valueOf(ViewCompat.getElevation(view));
                ViewCompat.setElevation(view, 1.0f + findMaxElevation(recyclerView, view));
                view.setTag(C0315R.C0316id.item_touch_helper_previous_elevation, valueOf);
            }
        ...
        public void clearView(View view) {
            Object tag = view.getTag(C0315R.C0316id.item_touch_helper_previous_elevation);
            if (tag != null && (tag instanceof Float)) {
                ViewCompat.setElevation(view, ((Float) tag).floatValue());
            }
            view.setTag(C0315R.C0316id.item_touch_helper_previous_elevation, null);
