    ...
    public void runPendingAnimations() {
        ...
        if (z4 || z || z3 || z2) {
            ...
            if (z3) {
                ...
                if (z4 || z || z2) {
                    long removeDuration = z4 ? getRemoveDuration() : 0;
                    if (z) {
                        j = getMoveDuration();
                    } else {
                        j = 0;
                    ...
                    ViewCompat.postOnAnimationDelayed(((RecyclerView.ViewHolder) arrayList3.get(0)).itemView, r12, removeDuration + Math.max(j, j2));
                    return;
                }
                r12.run();
            }
