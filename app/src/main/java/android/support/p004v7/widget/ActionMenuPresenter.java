...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, C0309R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0309R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0309R.attr.actionOverflowMenuStyle);
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0309R.layout.abc_action_menu_layout, C0309R.layout.abc_action_menu_item_layout);
    }
    ...
    public boolean flagActionItems() {
        ...
        int i12 = this.mActionItemWidthLimit;
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
        ViewGroup viewGroup = (ViewGroup) this.mMenuView;
        int i13 = 0;
        int i14 = 0;
        ...
        if (this.mReserveOverflow && (z3 || i13 + i14 > i11)) {
            i11--;
        }
        int i16 = i11 - i13;
        ...
        if (this.mStrictWidthLimit) {
            i17 = i12 / this.mMinCellSize;
            i2 = ((i12 % this.mMinCellSize) / i17) + this.mMinCellSize;
        } else {
            i2 = 0;
        }
        int i18 = 0;
        ...
        while (i18 < i) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (this.mStrictWidthLimit) {
                    i20 -= ActionMenuView.measureChildForCells(itemView, i2, i20, makeMeasureSpec, 0);
                } else {
                ...
                boolean z5 = (i16 > 0 || z4) && i12 > 0 && (!this.mStrictWidthLimit || i20 > 0);
                if (z5) {
                    ...
                    if (this.mStrictWidthLimit) {
                        int measureChildForCells = ActionMenuView.measureChildForCells(itemView2, i2, i20, makeMeasureSpec, 0);
