    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
        ...
        while (true) {
            ...
            if (depth2 < depth && next == 3) {
                ...
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet, C0309R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0309R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0309R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0309R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0309R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0309R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                ...
                while (i4 < attributeCount) {
                    ...
                    if (attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0309R.attr.alpha) {
                        i = i3;
                    } else {
                        int i5 = i3 + 1;
