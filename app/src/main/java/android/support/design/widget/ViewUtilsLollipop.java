...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(View view, float f) {
        ...
        stateListAnimator.addState(new int[]{16842766, C0030R.attr.state_collapsible, -C0030R.attr.state_collapsed}, ObjectAnimator.ofFloat(view, "elevation", new float[]{0.0f}).setDuration((long) integer));
