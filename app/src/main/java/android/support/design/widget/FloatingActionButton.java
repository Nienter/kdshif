...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attributeSet) {
            ...
            this.mAutoHideEnabled = obtainStyledAttributes.getBoolean(C0030R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0030R.styleable.FloatingActionButton, i, C0030R.C0033style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = obtainStyledAttributes.getColorStateList(C0030R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0030R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
