...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0030R.styleable.CollapsingToolbarLayout, i, C0030R.C0033style.Widget_Design_CollapsingToolbar);
        ...
        this.mCollapsingTextHelper.setExpandedTextAppearance(C0030R.C0033style.TextAppearance_Design_CollapsingToolbar_Expanded);
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0309R.C0312style.TextAppearance_AppCompat_Widget_ActionBar_Title);
