...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0030R.styleable.TextInputLayout, i, C0030R.C0033style.Widget_Design_TextInputLayout);
        ...
        if (obtainStyledAttributes.hasValue(C0030R.styleable.TextInputLayout_passwordToggleTintMode)) {
            ...
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0030R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (this.mErrorEnabled != z) {
            ...
            if (z) {
                ...
                this.mErrorView.setId(C0030R.C0032id.textinput_error);
                ...
                if (z2) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0309R.C0312style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0030R.color.design_textinput_error_color_light));
                }
        ...
        if (this.mCounterEnabled != z) {
            if (z) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0309R.C0312style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0030R.color.design_textinput_error_color_light));
                }
        ...
        if (this.mEditText != null) {
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0030R.layout.design_text_input_password_icon, this.mInputFrame, false);
