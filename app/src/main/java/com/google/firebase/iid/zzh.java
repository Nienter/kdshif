...
class zzh {
    ...
    static class zza {
        ...
        public boolean zzjC(String str) {
    ...
    private void zzeL(String str) {
        SharedPreferences.Editor edit = this.zzbhD.edit();
        for (String next : this.zzbhD.getAll().keySet()) {
    ...
    /* access modifiers changed from: package-private */
    public synchronized void zzeN(String str) {
    ...
    /* access modifiers changed from: package-private */
    public synchronized KeyPair zzjA(String str) {
        KeyPair zzGs;
        zzGs = zza.zzGs();
