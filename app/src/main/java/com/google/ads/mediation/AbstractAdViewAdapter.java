...
public abstract class AbstractAdViewAdapter implements MediationBannerAdapter, MediationNativeAdapter, MediationRewardedVideoAdAdapter, zzrd {
    ...
    public InterstitialAd zzcG;
    /* access modifiers changed from: private */
    public MediationRewardedVideoAdListener zzcH;
    final RewardedVideoAdListener zzcI = new RewardedVideoAdListener() {
        ...
        public void onRewardedVideoAdClosed() {
            ...
            InterstitialAd unused = AbstractAdViewAdapter.this.zzcG = null;
        }

        public void onRewardedVideoAdFailedToLoad(int i) {
            AbstractAdViewAdapter.this.zzcH.onAdFailedToLoad(AbstractAdViewAdapter.this, i);
        }
    ...
    public void loadAd(MediationAdRequest mediationAdRequest, Bundle bundle, Bundle bundle2) {
        if (this.zzcF == null || this.zzcH == null) {
            zzpy.m2432e("AdMobAdapter.loadAd called before initialize.");
            return;
        }
