...
public final class CustomEventAdapter implements MediationBannerAdapter<CustomEventExtras, CustomEventServerParameters>, MediationInterstitialAdapter<CustomEventExtras, CustomEventServerParameters> {
    ...
    static final class zza implements CustomEventBannerListener {
        ...
        public void onFailedToReceiveAd() {
            zzpy.zzbc("Custom event adapter called onFailedToReceiveAd.");
            this.zzcZ.onFailedToReceiveAd(this.zzcY, AdRequest.ErrorCode.NO_FILL);
        }
    ...
    class zzb implements CustomEventInterstitialListener {
        ...
        public void onFailedToReceiveAd() {
            zzpy.zzbc("Custom event adapter called onFailedToReceiveAd.");
            this.zzda.onFailedToReceiveAd(this.zzcY, AdRequest.ErrorCode.NO_FILL);
        }
        ...
        public void onReceivedAd() {
            zzpy.zzbc("Custom event adapter called onReceivedAd.");
            this.zzda.onReceivedAd(CustomEventAdapter.this);
        }
    }
