...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        private static class C1703zza implements zzb {
            private IBinder zzrp;

            C1703zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzb zzcZ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzb)) ? new C1703zza(iBinder) : (zzb) queryLocalInterface;
        }
