...
public interface zzacc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzacc {
        ...
        private static class C1706zza implements zzacc {
            private IBinder zzrp;

            C1706zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzacc zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzacc)) ? new C1706zza(iBinder) : (zzacc) queryLocalInterface;
        }
