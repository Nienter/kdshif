...
public final class zzkd implements NativeMediationAdRequest {
    ...
    public zzkd(@Nullable Date date, int i, @Nullable Set<String> set, @Nullable Location location, boolean z, int i2, zzgw zzgw, List<String> list, boolean z2) {
        this.zzcQ = date;
        this.zzyW = i;
        this.zzcS = set;
        this.zzcU = location;
    ...
    public boolean isContentAdRequested() {
        return this.zzto != null && this.zzto.contains(AppEventsConstants.EVENT_PARAM_VALUE_YES);
    }
