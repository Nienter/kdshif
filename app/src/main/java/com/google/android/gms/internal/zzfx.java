...
public final class zzfx {
    ...
    public static final zzft<Boolean> zzAS = zzft.zza(0, "gads:request_builder:singleton_webview", (Boolean) false);
    public static final zzft<String> zzAT = zzft.zza(0, "gads:request_builder:singleton_webview_experiment_id");
    public static final zzft<Boolean> zzAU = zzft.zza(0, "gads:sdk_use_dynamic_module", (Boolean) true);
    public static final zzft<String> zzAV = zzft.zza(0, "gads:sdk_use_dynamic_module_experiment_id");
    public static final zzft<Boolean> zzAW = zzft.zza(0, "gads:sdk_crash_report_enabled", (Boolean) false);
    public static final zzft<Boolean> zzAX = zzft.zza(0, "gads:sdk_crash_report_full_stacktrace", (Boolean) false);
    public static final zzft<String> zzAY = zzft.zza(0, "gads:sdk_crash_report_class_prefix", "com.google.");
    public static final zzft<Boolean> zzAZ = zzft.zza(0, "gads:block_autoclicks", (Boolean) false);
    public static final zzft<Boolean> zzBA = zzft.zza(0, "gads:ad_id_app_context:enabled", (Boolean) false);
    ...
    public static final zzft<Boolean> zzBE = zzft.zza(0, "gads:looper_for_gms_client:enabled", (Boolean) true);
    public static final zzft<Boolean> zzBF = zzft.zza(0, "gads:sw_ad_request_service:enabled", (Boolean) true);
    public static final zzft<Boolean> zzBG = zzft.zza(0, "gads:sw_dynamite:enabled", (Boolean) true);
    ...
    public static final zzft<Boolean> zzBK = zzft.zza(0, "gads:enabled_sdk_csi", (Boolean) false);
    public static final zzft<String> zzBL = zzft.zza(0, "gads:sdk_csi_server", "https://csi.gstatic.com/csi");
    public static final zzft<Boolean> zzBM = zzft.zza(0, "gads:sdk_csi_write_to_file", (Boolean) false);
    public static final zzft<Boolean> zzBN = zzft.zza(1, "gads:use_adx_javascript_adapter", (Boolean) false);
    public static final zzft<Boolean> zzBO = zzft.zza(0, "gads:enable_content_fetching", (Boolean) true);
    ...
    public static final zzft<Boolean> zzBU = zzft.zza(1, "gads:enable_content_url_hash", (Boolean) true);
    public static final zzft<Integer> zzBV = zzft.zza(1, "gads:content_vertical_fingerprint_number", 100);
    public static final zzft<Boolean> zzBW = zzft.zza(1, "gads:enable_content_vertical_hash", (Boolean) true);
    ...
    public static final zzft<Boolean> zzBd = zzft.zza(1, "gads:spam_app_context:enabled", (Boolean) false);
    public static final zzft<Integer> zzBe = zzft.zza(1, "gads:http_url_connection_factory:timeout_millis", (int) AbstractSpiCall.DEFAULT_TIMEOUT);
    public static final zzft<String> zzBf = zzft.zza(1, "gads:video_exo_player:version", AppEventsConstants.EVENT_PARAM_VALUE_YES);
    ...
    public static final zzft<Integer> zzBn = zzft.zza(1, "gads:video_stream_cache:connect_timeout_millis", (int) AbstractSpiCall.DEFAULT_TIMEOUT);
    public static final zzft<Boolean> zzBo = zzft.zza(0, "gads:video:metric_reporting_enabled", (Boolean) false);
    ...
    public static final zzft<Boolean> zzBr = zzft.zza(1, "gads:video:force_watermark", (Boolean) false);
    public static final zzft<Long> zzBs = zzft.zza(1, "gads:video:surface_update_min_spacing_ms", 1000);
    public static final zzft<Boolean> zzBt = zzft.zza(1, "gads:video:spinner:enabled", (Boolean) false);
    ...
    public static final zzft<Boolean> zzBw = zzft.zza(1, "gads:memory_bundle:debug_info", (Boolean) false);
    public static final zzft<Boolean> zzBx = zzft.zza(1, "gads:memory_bundle:runtime_info", (Boolean) true);
    public static final zzft<String> zzBy = zzft.zzb(0, "gads:spam_ad_id_decorator:experiment_id");
    public static final zzft<Boolean> zzBz = zzft.zza(0, "gads:spam_ad_id_decorator:enabled", (Boolean) false);
    public static final zzft<Boolean> zzCA = zzft.zza(1, "gads:interstitial_ad_pool:enabled", (Boolean) false);
    public static final zzft<Boolean> zzCB = zzft.zza(1, "gads:interstitial_ad_pool:enabled_for_rewarded", (Boolean) false);
    ...
    public static final zzft<Boolean> zzCL = zzft.zza(0, "gads:log:verbose_enabled", (Boolean) false);
    public static final zzft<Boolean> zzCM = zzft.zza(1, "gads:include_local_global_rectangles", (Boolean) false);
    ...
    public static final zzft<Boolean> zzCP = zzft.zza(0, "gads:device_info_caching:enabled", (Boolean) true);
    public static final zzft<Long> zzCQ = zzft.zza(0, "gads:device_info_caching_expiry_ms:expiry", 300000);
    public static final zzft<Boolean> zzCR = zzft.zza(0, "gads:gen204_signals:enabled", (Boolean) false);
    public static final zzft<Boolean> zzCS = zzft.zza(0, "gads:webview:error_reporting_enabled", (Boolean) false);
    public static final zzft<Boolean> zzCT = zzft.zza(0, "gads:adid_reporting:enabled", (Boolean) false);
    public static final zzft<Boolean> zzCU = zzft.zza(0, "gads:ad_settings_page_reporting:enabled", (Boolean) false);
    public static final zzft<Boolean> zzCV = zzft.zza(0, "gads:adid_info_gmscore_upgrade_reporting:enabled", (Boolean) false);
    public static final zzft<Boolean> zzCW = zzft.zza(0, "gads:request_pkg:enabled", (Boolean) true);
    public static final zzft<Boolean> zzCX = zzft.zza(1, "gads:gmsg:disable_back_button:enabled", (Boolean) true);
    public static final zzft<Boolean> zzCY = zzft.zza(0, "gads:gmsg:video_meta:enabled", (Boolean) true);
    ...
    public static final zzft<Boolean> zzCb = zzft.zza(0, "gad:app_index_enabled", (Boolean) true);
    public static final zzft<Boolean> zzCc = zzft.zza(0, "gads:app_index:without_content_info_present:enabled", (Boolean) true);
    ...
    public static final zzft<Boolean> zzCg = zzft.zza(0, "gads:kitkat_interstitial_workaround:enabled", (Boolean) true);
    public static final zzft<Boolean> zzCh = zzft.zza(0, "gads:interstitial_follow_url", (Boolean) true);
    public static final zzft<Boolean> zzCi = zzft.zza(0, "gads:interstitial_follow_url:register_click", (Boolean) true);
    public static final zzft<String> zzCj = zzft.zza(0, "gads:interstitial_follow_url:experiment_id");
    public static final zzft<Boolean> zzCk = zzft.zza(0, "gads:analytics_enabled", (Boolean) true);
    public static final zzft<Boolean> zzCl = zzft.zza(0, "gads:ad_key_enabled", (Boolean) false);
    public static final zzft<Integer> zzCm = zzft.zza(0, "gads:webview_cache_version", 0);
    public static final zzft<Boolean> zzCn = zzft.zza(1, "gads:webview_recycle:enabled", (Boolean) false);
    public static final zzft<String> zzCo = zzft.zza(1, "gads:webview_recycle:experiment_id");
    public static final zzft<Boolean> zzCp = zzft.zza(1, "gads:webview:ignore_over_scroll", (Boolean) true);
    ...
    public static final zzft<Boolean> zzCt = zzft.zza(1, "gads:app_activity_tracker:enabled", (Boolean) true);
    ...
    public static final zzft<Boolean> zzCw = zzft.zza(0, "gads:ad_serving:enabled", (Boolean) true);
    public static final zzft<String> zzCx = zzft.zza(1, "gads:ad_manager_enforce_arp_invariant:experiment_id");
    public static final zzft<Boolean> zzCy = zzft.zza(1, "gads:ad_manager_enforce_arp_invariant:enabled", (Boolean) false);
    public static final zzft<Long> zzCz = zzft.zza(1, "gads:ad_overlay:delay_page_close_timeout_ms", 5000);
    public static final zzft<Boolean> zzDA = zzft.zza(1, "gads:gestures:visibility:enabled", (Boolean) false);
    public static final zzft<Boolean> zzDB = zzft.zza(1, "gads:gestures:check_initialization_thread:enabled", (Boolean) false);
    public static final zzft<Boolean> zzDC = zzft.zza(1, "gads:gestures:get_query_in_non_ui_thread:enabled", (Boolean) true);
    public static final zzft<Boolean> zzDD = zzft.zza(0, "gass:client:enabled", (Boolean) true);
    public static final zzft<String> zzDE = zzft.zza(0, "gass:client:experiment_id");
    public static final zzft<Boolean> zzDF = zzft.zza(0, "gass:enabled", (Boolean) true);
    public static final zzft<Boolean> zzDG = zzft.zza(0, "gass:enable_int_signal", (Boolean) true);
    public static final zzft<Boolean> zzDH = zzft.zza(0, "gads:adid_notification:first_party_check:enabled", (Boolean) true);
    public static final zzft<Boolean> zzDI = zzft.zza(0, "gads:edu_device_helper:enabled", (Boolean) true);
    public static final zzft<Boolean> zzDJ = zzft.zza(0, "gads:support_screen_shot", (Boolean) true);
    public static final zzft<Boolean> zzDK = zzft.zza(0, "gads:use_get_drawing_cache_for_screenshot:enabled", (Boolean) true);
    ...
    public static final zzft<Boolean> zzDP = zzft.zza(0, "gads:js_flags:mf", (Boolean) false);
    public static final zzft<Boolean> zzDQ = zzft.zza(0, "gads:custom_render:ping_on_ad_rendered", (Boolean) false);
    ...
    public static final zzft<Boolean> zzDT = zzft.zza(1, "gads:singleton_webview_native", (Boolean) false);
    public static final zzft<String> zzDU = zzft.zza(1, "gads:singleton_webview_native:experiment_id");
    public static final zzft<Boolean> zzDV = zzft.zza(1, "gads:enable_untrack_view_native", (Boolean) true);
    public static final zzft<Boolean> zzDW = zzft.zza(1, "gads:ignore_untrack_view_google_native", (Boolean) true);
    public static final zzft<Boolean> zzDX = zzft.zza(1, "gads:reset_listeners_preparead_native", (Boolean) true);
    ...
    public static final zzft<Boolean> zzDb = zzft.zza(0, "gads:mediation:dynamite_first:admobadapter", (Boolean) true);
    public static final zzft<Boolean> zzDc = zzft.zza(0, "gads:mediation:dynamite_first:adurladapter", (Boolean) true);
    ...
    public static final zzft<Boolean> zzDf = zzft.zza(0, "gads:adshield:enable_adshield_instrumentation", (Boolean) false);
    ...
    public static final zzft<Boolean> zzDi = zzft.zza(1, "gads:gestures:encrypt_size_limit:enabled", (Boolean) false);
    public static final zzft<String> zzDj = zzft.zza(1, "gads:gestures:appid:experiment_id");
    public static final zzft<Boolean> zzDk = zzft.zza(1, "gads:gestures:appid:enabled", (Boolean) false);
    public static final zzft<Boolean> zzDl = zzft.zza(0, "gads:gestures:v6:enabled", (Boolean) false);
    public static final zzft<String> zzDm = zzft.zza(1, "gads:gestures:usb_query:experiment_id");
    public static final zzft<Boolean> zzDn = zzft.zza(1, "gads:gestures:usb_query:enabled", (Boolean) false);
    public static final zzft<String> zzDo = zzft.zza(1, "gads:gestures:usb_click:experiment_id");
    public static final zzft<Boolean> zzDp = zzft.zza(1, "gads:gestures:usb_click:enabled", (Boolean) false);
    public static final zzft<Boolean> zzDq = zzft.zza(1, "gads:gestures:touchinfo:enabled", (Boolean) false);
    public static final zzft<String> zzDr = zzft.zza(1, "gads:gestures:touchinfo:experiment_id");
    public static final zzft<Boolean> zzDs = zzft.zza(1, "gads:gestures:clock_query:enabled", (Boolean) false);
    public static final zzft<String> zzDt = zzft.zza(1, "gads:gestures:clock_query:experiment_id");
    public static final zzft<Boolean> zzDu = zzft.zza(1, "gads:gestures:clock_click:enabled", (Boolean) false);
    public static final zzft<String> zzDv = zzft.zza(1, "gads:gestures:clock_click:experiment_id");
    public static zzft<Boolean> zzDw = zzft.zza(1, "gads:gestures:btl_click:enabled", (Boolean) false);
    ...
    public static final zzft<Boolean> zzDz = zzft.zza(1, "gads:gestures:click_stk:enabled", (Boolean) true);
    public static final zzft<Boolean> zzEA = zzft.zza(0, "gads:afs:csa_ad_manager_enabled", (Boolean) true);
    public static final zzft<Boolean> zzEB = zzft.zza(1, "gads:parental_controls:send_from_client", (Boolean) true);
    public static final zzft<Boolean> zzEC = zzft.zza(1, "gads:parental_controls:cache_results", (Boolean) true);
    ...
    public static final zzft<Boolean> zzEG = zzft.zza(0, "gads:safe_browsing:debug", (Boolean) false);
    public static final zzft<Boolean> zzEH = zzft.zza(0, "gads:webview_cookie:enabled", (Boolean) true);
    ...
    public static final zzft<Boolean> zzEK = zzft.zza(1, "gads:cache:bind_on_foreground", (Boolean) false);
    public static final zzft<Boolean> zzEL = zzft.zza(1, "gads:cache:bind_on_init", (Boolean) false);
    public static final zzft<Boolean> zzEM = zzft.zza(1, "gads:cache:bind_on_request", (Boolean) false);
    public static final zzft<Long> zzEN = zzft.zza(1, "gads:cache:bind_on_request_keep_alive", TimeUnit.SECONDS.toMillis(30));
    public static final zzft<Boolean> zzEO = zzft.zza(1, "gads:cache:use_cache_data_source", (Boolean) false);
    public static final zzft<Boolean> zzEP = zzft.zza(1, "gads:chrome_custom_tabs:enabled", (Boolean) true);
    public static final zzft<Boolean> zzEQ = zzft.zza(1, "gads:drx_in_app_preview:enabled", (Boolean) false);
    public static final zzft<Boolean> zzER = zzft.zza(1, "gads:drx_debug_signals:enabled", (Boolean) false);
    ...
    public static final zzft<Boolean> zzEY = zzft.zza(1, "gad:interstitial_for_multi_window", (Boolean) false);
    public static final zzft<Boolean> zzEZ = zzft.zza(1, "gad:interstitial_ad_stay_active_in_multi_window", (Boolean) false);
    public static final zzft<String> zzEa = zzft.zza(1, "gads:ad_choices_content_description", "Ad Choices Icon");
    public static final zzft<Boolean> zzEb = zzft.zza(1, "gads:clamp_native_video_player_dimensions", (Boolean) true);
    public static final zzft<Boolean> zzEc = zzft.zza(1, "gads:enable_tracking_for_native_ad_views", (Boolean) true);
    public static final zzft<Boolean> zzEd = zzft.zza(1, "gads:use_new_json_for_native_view_tracking", (Boolean) true);
    public static final zzft<Boolean> zzEe = zzft.zza(1, "gads:fluid_ad:use_wrap_content_height", (Boolean) false);
    public static final zzft<Boolean> zzEf = zzft.zza(0, "gads:method_tracing:enabled", (Boolean) false);
    ...
    public static final zzft<Boolean> zzEj = zzft.zza(1, "gads:auto_location_for_coarse_permission", (Boolean) false);
    ...
    public static final zzft<Boolean> zzEp = zzft.zza(1, "gads:fetch_app_settings_using_cld:enabled", (Boolean) false);
    ...
    public static void initialize(final Context context) {
        zzpv.zzb(new Callable<Void>() {
            /* renamed from: zzbl */
            public Void call() {
                zzv.zzcV().initialize(context);
                return null;
            }
        });
    }
