...
public interface zzhk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhk {
        ...
        private static class C1747zza implements zzhk {
            private IBinder zzrp;

            C1747zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
            ...
            public void zza(zzhf zzhf) {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(zzhf != null ? zzhf.asBinder() : null);
        ...
        public static zzhk zzI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhk)) ? new C1747zza(iBinder) : (zzhk) queryLocalInterface;
        }
