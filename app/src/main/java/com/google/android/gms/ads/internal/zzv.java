...
public class zzv {
    ...
    private final zzf zzuA = new zzf();
    private final zzln zzuB = new zzln();
    private final zzpi zzuC = new zzpi();
    private final zzqr zzuD = new zzqr();
    private final zzpj zzuE = zzpj.zzah(Build.VERSION.SDK_INT);
    ...
    protected static void zza(zzv zzv) {
        synchronized (zztU) {
            zzux = zzv;
        }
    }
