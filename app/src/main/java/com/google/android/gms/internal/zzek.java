...
public interface zzek extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzek {
        ...
        private static class C1724zza implements zzek {
            private IBinder zzrp;

            C1724zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzek zzl(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzek)) ? new C1724zza(iBinder) : (zzek) queryLocalInterface;
        }
