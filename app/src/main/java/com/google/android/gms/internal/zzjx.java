...
public interface zzjx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjx {
        ...
        private static class C1755zza implements zzjx {
            private IBinder zzrp;

            C1755zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzjx zzR(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjx)) ? new C1755zza(iBinder) : (zzjx) queryLocalInterface;
        }
