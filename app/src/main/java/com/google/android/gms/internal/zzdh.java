...
public class zzdh {
    ...
    public static class zza {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return ((zza) obj).value == this.value && ((zza) obj).zzyk == this.zzyk;
        }
    ...
    static String zza(String[] strArr, int i, int i2) {
        if (strArr.length < i + i2) {
            zzpe.m2432e("Unable to construct shingle");
            return "";
        }
    ...
    static void zza(int i, long j, String str, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        if ((priorityQueue.size() != i || (priorityQueue.peek().zzyk <= zza2.zzyk && priorityQueue.peek().value <= zza2.value)) && !priorityQueue.contains(zza2)) {
    ...
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        while (i3 < (strArr.length - i2) + 1) {
            long zza3 = zza(zzdf.zzH(strArr[i3 - 1]), zzdf.zzH(strArr[(i3 + i2) - 1]), zzb, zza2, 16785407);
