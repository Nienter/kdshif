...
public interface zzhm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhm {
        ...
        private static class C1749zza implements zzhm {
            private IBinder zzrp;

            C1749zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzhm zzK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhm)) ? new C1749zza(iBinder) : (zzhm) queryLocalInterface;
        }
