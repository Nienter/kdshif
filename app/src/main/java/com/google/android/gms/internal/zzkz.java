...
public interface zzkz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkz {
        ...
        private static class C1759zza implements zzkz {
            private IBinder zzrp;

            C1759zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
            ...
            public void zza(zzky zzky) {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(zzky != null ? zzky.asBinder() : null);
        ...
        public static zzkz zzX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkz)) ? new C1759zza(iBinder) : (zzkz) queryLocalInterface;
        }
