...
public class zzzl {
    ...
    private static long zzo(byte[] bArr) {
        ...
        long j2 = zzb8 + zzb6;
        return zzH((zzH(((Long.rotateRight(zzb8, 31) + rotateRight5 + rotateRight6 + Long.rotateRight(zzb7, 7) + j) * -4288712594273399085L) + ((j2 + rotateRight4) * -6505348102511208375L)) * -6505348102511208375L) + rotateRight4) * -4288712594273399085L;
    }
    ...
    private static long zzp(byte[] bArr) {
        ...
        long rotateRight = -8261664234251669945L * Long.rotateRight(zzH + zzb, 39);
        ...
        while (true) {
            ...
            long rotateRight4 = Long.rotateRight(zzH ^ jArr2[0], 33);
            zza(bArr, i2, jArr[1] * -8261664234251669945L, jArr2[0] + rotateRight3, jArr);
            zza(bArr, i2 + 32, rotateRight4 + jArr2[1], rotateRight2, jArr2);
            i2 += 64;
            i -= 64;
            if (i == 0) {
                return zzc(zzc(jArr[0], jArr2[0]) + (zzH(rotateRight2) * -8261664234251669945L) + rotateRight3, zzc(jArr[1], jArr2[1]) + rotateRight4);
            }
            zzH = rotateRight3;
            j = rotateRight4;
        }
