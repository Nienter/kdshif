...
public interface zzem extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzem {
        ...
        private static class C1726zza implements zzem {
            private IBinder zzrp;

            C1726zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzem zzn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzem)) ? new C1726zza(iBinder) : (zzem) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zzf(parcel.readInt() != 0 ? zzdy.CREATOR.createFromParcel(parcel) : null);
