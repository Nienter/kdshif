...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C1687zza implements zzr {
            private IBinder zzrp;

            C1687zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzr zzbr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C1687zza(iBinder) : (zzr) queryLocalInterface;
        }
