...
public interface zzev extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzev {
        ...
        private static class C1735zza implements zzev {
            private IBinder zzrp;

            C1735zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzev zzv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzev)) ? new C1735zza(iBinder) : (zzev) queryLocalInterface;
        }
