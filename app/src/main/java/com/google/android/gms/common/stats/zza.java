...
public class zza {
    ...
    private zza() {
        ...
        this.zzaFV = str2 == null ? Collections.EMPTY_LIST : Arrays.asList(str2.split(","));
        String str3 = zzb.zza.zzaGg.get();
        this.zzaFW = str3 == null ? Collections.EMPTY_LIST : Arrays.asList(str3.split(","));
        String str4 = zzb.zza.zzaGh.get();
        this.zzaFX = str4 == null ? Collections.EMPTY_LIST : Arrays.asList(str4.split(","));
        this.zzaFY = new zzd(1024, zzb.zza.zzaGi.get().longValue());
        this.zzaGa = new zzd(1024, zzb.zza.zzaGi.get().longValue());
    }
