...
public final class zznf {
    ...
    public static final class zza {
        ...
        public zza(Context context) {
            ...
            this.zzUc = zza(packageManager, "http://www.google.com") == null ? false : z;
        ...
        public zza(Context context, zznf zznf) {
            PackageManager packageManager = context.getPackageManager();
            zzs(context);
            zza(context, packageManager);
            zzt(context);
        ...
        private void zzt(Context context) {
            ...
            if (registerReceiver != null) {
                ...
                this.zzUr = (double) (((float) registerReceiver.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1)) / ((float) registerReceiver.getIntExtra("scale", -1)));
