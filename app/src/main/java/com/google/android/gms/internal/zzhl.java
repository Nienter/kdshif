...
public interface zzhl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhl {
        ...
        private static class C1748zza implements zzhl {
            private IBinder zzrp;

            C1748zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
            ...
            public void zza(zzhh zzhh, String str) {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(zzhh != null ? zzhh.asBinder() : null);
        ...
        public static zzhl zzJ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhl)) ? new C1748zza(iBinder) : (zzhl) queryLocalInterface;
        }
