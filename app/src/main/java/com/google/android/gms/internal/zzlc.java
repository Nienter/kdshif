...
public interface zzlc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlc {
        ...
        private static class C1762zza implements zzlc {
            private IBinder zzrp;

            C1762zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzlc zzaa(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlc)) ? new C1762zza(iBinder) : (zzlc) queryLocalInterface;
        }
