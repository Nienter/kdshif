...
public class zze {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        boolean z = !zzi.zzaJ(context) && !zzi.zzaL(context);
        ...
        try {
            ...
            if (z) {
                zzd.zza zza = zzav.zza(packageInfo, zzd.C1694zzd.zzaxk);
                if (zza == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return 9;
                }
                if (zzav.zza(packageInfo2, zza) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                    return 9;
                }
            } else if (zzav.zza(packageInfo2, zzd.C1694zzd.zzaxk) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
    ...
    private static void zzau(Context context) {
        try {
            ...
            if (packageInfo != null) {
                if (zzf.zzav(context).zza(packageInfo, zzd.C1694zzd.zzaxk[1]) != null) {
                    zzaxn = true;
                }
            }
            zzaxn = false;
    ...
    static boolean zzs(Context context, String str) {
        ...
        try {
            ...
            return applicationInfo.enabled && !zzas(context);
        } catch (PackageManager.NameNotFoundException e) {
            return false;
        }
    }
