...
public final class zzw implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void removeAllViews() {
            ArrayList<zzqp> arrayList = new ArrayList<>();
            int i = 0;
            while (true) {
                int i2 = i;
                if (i2 >= getChildCount()) {
        ...
        public void zzdo() {
            zzpe.m2431v("Disable position monitoring on adFrame.");
            if (this.zzvP != null) {
                this.zzvP.zzkF();
            }
        }
        ...
        public void zzdt() {
            zzpe.m2431v("Enable debug gesture detector on adFrame.");
            this.zzvQ = true;
        }

        public void zzdu() {
            zzpe.m2431v("Disable debug gesture detector on adFrame.");
            this.zzvQ = false;
        }
    }

    public zzw(Context context, zzec zzec, String str, zzqa zzqa) {
        this(context, zzec, str, zzqa, null);
    }

    zzw(Context context, zzec zzec, String str, zzqa zzqa, zzav zzav) {
        this.zzvD = null;
        this.zzvE = null;
        this.zzvF = 0;
        this.zzvG = false;
        ...
        if (zzv.zzcN().zzjN() != null) {
            ...
            if (zzqa.zzYb != 0) {
                zzfo.add(Integer.toString(zzqa.zzYb));
            }
            zzv.zzcN().zzjN().zzc(zzfo);
        }
        this.zzvc = UUID.randomUUID().toString();
        if (zzec.zzzl || zzec.zzzn) {
            this.zzvg = null;
        } else {
            this.zzvg = new zza(context, str, this, this);
            this.zzvg.setMinimumWidth(zzec.widthPixels);
            this.zzvg.setMinimumHeight(zzec.heightPixels);
        ...
        this.zzqr = context;
        this.zzvf = zzqa;
        this.zzve = zzav == null ? new zzav(new zzi(this)) : zzav;
