...
public interface zzhb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhb {
        ...
        private static class C1741zza implements zzhb {
            private IBinder zzrp;

            C1741zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzhb zzC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhb)) ? new C1741zza(iBinder) : (zzhb) queryLocalInterface;
        }
