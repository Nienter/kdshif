...
public class zzl {
    public static boolean zza(PublicKey publicKey, String str, String str2) {
        try {
            ...
            zzpe.m2432e("Signature verification failed.");
            return false;
        } catch (NoSuchAlgorithmException e) {
            zzpe.m2432e("NoSuchAlgorithmException.");
            return false;
        } catch (InvalidKeyException e2) {
            zzpe.m2432e("Invalid key specification.");
            return false;
        } catch (SignatureException e3) {
            zzpe.m2432e("Signature exception.");
            return false;
        }
    }
    ...
    public static boolean zzc(String str, String str2, String str3) {
        ...
        zzpe.m2432e("Purchase verification failed: missing data.");
        return false;
    }
}
