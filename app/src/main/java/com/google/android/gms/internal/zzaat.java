...
public interface zzaat extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaat {
        ...
        private static class C1704zza implements zzaat {
            private IBinder zzrp;

            C1704zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzaat zzbp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaat)) ? new C1704zza(iBinder) : (zzaat) queryLocalInterface;
        }
