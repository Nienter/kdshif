...
public interface zzhh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhh {
        ...
        private static class C1745zza implements zzhh {
            private IBinder zzrp;

            C1745zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzhh zzG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhh)) ? new C1745zza(iBinder) : (zzhh) queryLocalInterface;
        }
