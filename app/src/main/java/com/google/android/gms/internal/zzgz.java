...
public interface zzgz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgz {
        ...
        private static class C1740zza implements zzgz {
            private IBinder zzrp;

            C1740zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzgz zzB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgz)) ? new C1740zza(iBinder) : (zzgz) queryLocalInterface;
        }
