...
public class AppMeasurement {
    ...
    public static final class zzg extends FirebaseAnalytics.UserProperty {
        public static final Map<String, String> zzbpC = com.google.android.gms.common.util.zzf.zzb(new String[]{"firebase_last_notification", "first_open_time", "last_deep_link_referrer", AccessToken.USER_ID_KEY}, new String[]{"_ln", "_fot", "_ldl", "_id"});
    }
    ...
    public void registerOnScreenChangeCallback(@NonNull zzd zzd2) {
        this.zzbpw.zzJm().registerOnScreenChangeCallback(zzd2);
    }
    ...
    public void unregisterOnScreenChangeCallback(@NonNull zzd zzd2) {
        this.zzbpw.zzJm().unregisterOnScreenChangeCallback(zzd2);
    }

    @WorkerThread
    public void zza(zzb zzb2) {
        this.zzbpw.zzJi().zza(zzb2);
    }

    public void zza(zzc zzc2) {
        this.zzbpw.zzJi().zza(zzc2);
    }
    ...
    public Map<String, Object> zzaE(boolean z) {
        ...
        HashMap hashMap = new HashMap(zzaI.size());
        for (zzaub next : zzaI) {
