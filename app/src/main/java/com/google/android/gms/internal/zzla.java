...
public interface zzla extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzla {
        ...
        private static class C1760zza implements zzla {
            private IBinder zzrp;

            C1760zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzla zzY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzla)) ? new C1760zza(iBinder) : (zzla) queryLocalInterface;
        }
