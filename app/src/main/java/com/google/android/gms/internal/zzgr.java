...
public class zzgr extends zzhh.zza implements zzgu.zza {
    ...
    public zzgr(String str, SimpleArrayMap<String, zzgo> simpleArrayMap, SimpleArrayMap<String, String> simpleArrayMap2, zzgm zzgm) {
        this.zzGg = str;
    ...
    public List<String> getAvailableAssetNames() {
        ...
        for (int i3 = 0; i3 < this.zzGh.size(); i3++) {
            strArr[i2] = this.zzGh.keyAt(i3);
            i2++;
        }
        while (i < this.zzGi.size()) {
            strArr[i2] = this.zzGi.keyAt(i);
            i++;
            i2++;
        }
    ...
    public void performClick(String str) {
        synchronized (this.zzrN) {
            if (this.zzGd == null) {
                zzpy.m2432e("Attempt to call performClick before ad initialized.");
            } else {
    ...
    public void recordImpression() {
        synchronized (this.zzrN) {
            if (this.zzGd == null) {
                zzpy.m2432e("Attempt to perform recordImpression before ad initialized.");
            } else {
