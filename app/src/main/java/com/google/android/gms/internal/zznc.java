...
public final class zznc {
    ...
    public zznc(zzmh zzmh, String str) {
        this.zzTp = str;
        this.zzKG = zzmh;
    }
    ...
    private void zzM(Map<String, List<String>> map) {
        ...
        if (zzc == null || TextUtils.isEmpty(zzc)) {
            ...
            boolean booleanValue = zzfx.zzAZ.get().booleanValue();
            String valueOf = String.valueOf(buildUpon.toString());
            String valueOf2 = String.valueOf("navigationURL");
            this.zzTK = new zzmm(booleanValue, Arrays.asList(new String[]{new StringBuilder(String.valueOf(valueOf).length() + 18 + String.valueOf(valueOf2).length()).append(valueOf).append("&").append(valueOf2).append("={NAVIGATION_URL}").toString()}));
            return;
        }
        try {
    ...
    private void zzt(Map<String, List<String>> map) {
        this.zzTA = AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_NATIVE.equals(zzc(map, "X-Afma-Ad-Format"));
    }
