...
public class ProviderInstaller {
    ...
    public static final zzc zzbCa = zzc.zzuz();
    ...
    public static void installIfNeededAsync(final Context context, final ProviderInstallListener providerInstallListener) {
        ...
        new AsyncTask<Void, Void, Integer>() {
            ...
            public void onPostExecute(Integer num) {
                ...
                providerInstallListener.onProviderInstallFailed(num.intValue(), ProviderInstaller.zzbCa.zzb(context, num.intValue(), "pi"));
            }
        }.execute(new Void[0]);
    }
