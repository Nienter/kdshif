...
public final class zzmk extends zza {
    ...
    zzmk(int i, String str, String str2, List<String> list, int i2, List<String> list2, long j, boolean z, long j2, List<String> list3, long j3, int i3, String str3, long j4, String str4, boolean z2, String str5, String str6, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, zzms zzms, String str7, String str8, boolean z8, boolean z9, zzok zzok, List<String> list4, List<String> list5, boolean z10, zzmm zzmm, boolean z11, String str9, List<String> list6, boolean z12, String str10, zzon zzon, String str11, boolean z13) {
        this.versionCode = i;
        this.zzNb = str;
        this.body = str2;
        ...
        if (this.body == null && this.zzRW != null) {
            zzmv zzmv = (zzmv) this.zzRW.zza(zzmv.CREATOR);
            if (zzmv != null && !TextUtils.isEmpty(zzmv.zzje())) {
                this.body = zzmv.zzje();
            }
        }
        this.zzzo = z8;
    ...
    public zzmk(zzmh zzmh, String str, String str2, List<String> list, List<String> list2, long j, boolean z, long j2, List<String> list3, long j3, int i, String str3, long j4, String str4, String str5, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, String str6, boolean z7, boolean z8, zzok zzok, List<String> list4, List<String> list5, boolean z9, zzmm zzmm, boolean z10, String str7, List<String> list6, boolean z11, String str8, zzon zzon, String str9, boolean z12) {
        this(18, str, str2, list, -2, list2, j, z, j2, list3, j3, i, str3, j4, str4, false, null, str5, z2, z3, z4, z5, z6, null, null, str6, z7, z8, zzok, list4, list5, z9, zzmm, z10, str7, list6, z11, str8, zzon, str9, z12);
        this.zzKG = zzmh;
    }

    public zzmk(zzmh zzmh, String str, String str2, List<String> list, List<String> list2, long j, boolean z, long j2, List<String> list3, long j3, int i, String str3, long j4, String str4, boolean z2, String str5, String str6, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, String str7, boolean z8, boolean z9, zzok zzok, List<String> list4, List<String> list5, boolean z10, zzmm zzmm, boolean z11, String str8, List<String> list6, boolean z12, String str9, zzon zzon, String str10, boolean z13) {
        this(18, str, str2, list, -2, list2, j, z, j2, list3, j3, i, str3, j4, str4, z2, str5, str6, z3, z4, z5, z6, z7, null, null, str7, z8, z9, zzok, list4, list5, z10, zzmm, z11, str8, list6, z12, str9, zzon, str10, z13);
        this.zzKG = zzmh;
    }
