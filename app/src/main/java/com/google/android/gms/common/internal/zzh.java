...
public final class zzh {
    ...
    public static String zzg(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0955R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C0955R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C0955R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String zzg(Context context, String str, String str2) {
        ...
        if (zzu == null) {
            zzu = resources.getString(C0955R.string.common_google_play_services_unknown_issue);
        }
    ...
    public static String zzh(Context context, int i) {
        ...
        return zzu == null ? context.getResources().getString(C0955R.string.common_google_play_services_notification_ticker) : zzu;
    }
    ...
    public static String zzi(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0955R.string.common_google_play_services_install_text, new Object[]{zzaB});
            case 2:
                if (zzi.zzaJ(context)) {
                    return resources.getString(C0955R.string.common_google_play_services_wear_update_text);
                }
                return resources.getString(C0955R.string.common_google_play_services_update_text, new Object[]{zzaB});
            case 3:
                return resources.getString(C0955R.string.common_google_play_services_enable_text, new Object[]{zzaB});
            case 5:
            ...
            case 9:
                return resources.getString(C0955R.string.common_google_play_services_unsupported_text, new Object[]{zzaB});
            case 16:
            ...
            case 18:
                return resources.getString(C0955R.string.common_google_play_services_updating_text, new Object[]{zzaB});
            case 20:
                return zzg(context, "common_google_play_services_restricted_profile_text", zzaB);
            default:
                return resources.getString(C0955R.string.common_google_play_services_unknown_issue, new Object[]{zzaB});
        }
    }
    ...
    public static String zzk(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0955R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0955R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0955R.string.common_google_play_services_enable_button);
            default:
