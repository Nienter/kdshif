...
public final class zzef {
    ...
    public zzef(Context context, AttributeSet attributeSet) {
        boolean z = true;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0955R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C0955R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C0955R.styleable.AdsAttrs_adSizes);
        ...
        this.zztq = obtainAttributes.getString(C0955R.styleable.AdsAttrs_adUnitId);
