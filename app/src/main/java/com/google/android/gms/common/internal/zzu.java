...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C1689zza implements zzu {
            private IBinder zzrp;

            C1689zza(IBinder iBinder) {
                this.zzrp = iBinder;
            }
        ...
        public static zzu zzbt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C1689zza(iBinder) : (zzu) queryLocalInterface;
        }
