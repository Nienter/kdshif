...
import p005b.p006a.p007a.p008a.KitGroup;
...
public class Crashlytics extends Kit<Void> implements KitGroup {
    ...
    public static Crashlytics getInstance() {
        return (Crashlytics) Fabric.m447a(Crashlytics.class);
    }
    ...
    public void setDebugMode(boolean z) {
        Fabric.m456h().mo8513d(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        Fabric.m456h().mo8513d(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return Fabric.m457i();
    }
    ...
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfoProvider) {
        Fabric.m456h().mo8513d(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
