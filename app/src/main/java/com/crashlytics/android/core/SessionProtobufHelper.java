...
class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, int i, String str, int i2, long j, long j2, boolean z, Map<IdManager.C0430a, String> map, int i3, String str2, String str3) {
        ...
        for (Map.Entry next : map.entrySet()) {
            ...
            codedOutputStream.writeRawVarint32(getDeviceIdentifierSize((IdManager.C0430a) next.getKey(), (String) next.getValue()));
            codedOutputStream.writeEnum(1, ((IdManager.C0430a) next.getKey()).protobufIndex);
            codedOutputStream.writeBytes(2, ByteString.copyFromUtf8((String) next.getValue()));
        }
    ...
    private static int getDeviceIdentifierSize(IdManager.C0430a aVar, String str) {
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, int i2, long j, long j2, boolean z, Map<IdManager.C0430a, String> map, int i3, ByteString byteString2, ByteString byteString3) {
        ...
        int computeUInt32Size = computeBytesSize + computeEnumSize + CodedOutputStream.computeUInt32Size(5, i2) + CodedOutputStream.computeUInt64Size(6, j) + CodedOutputStream.computeUInt64Size(7, j2) + CodedOutputStream.computeBoolSize(10, z);
        if (map != null) {
            Iterator<Map.Entry<IdManager.C0430a, String>> it = map.entrySet().iterator();
            while (true) {
                i4 = computeUInt32Size;
                if (!it.hasNext()) {
                    break;
                }
                Map.Entry next = it.next();
                int deviceIdentifierSize = getDeviceIdentifierSize((IdManager.C0430a) next.getKey(), (String) next.getValue());
                computeUInt32Size = deviceIdentifierSize + CodedOutputStream.computeTagSize(11) + CodedOutputStream.computeRawVarint32Size(deviceIdentifierSize) + i4;
            }
        } else {
            i4 = computeUInt32Size;
        }
        return (byteString3 == null ? 0 : CodedOutputStream.computeBytesSize(14, byteString3)) + i4 + CodedOutputStream.computeUInt32Size(12, i3) + (byteString2 == null ? 0 : CodedOutputStream.computeBytesSize(13, byteString2));
    }
    ...
    private static int getFrameSize(StackTraceElement stackTraceElement, boolean z) {
        ...
        if (stackTraceElement.isNativeMethod() || stackTraceElement.getLineNumber() <= 0) {
            ...
            i = computeBytesSize + CodedOutputStream.computeUInt64Size(4, (long) stackTraceElement.getLineNumber());
        }
