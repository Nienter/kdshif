...
class LogFileManager {
    ...
    public final void setCurrentSession(String str) {
        ...
        this.currentLog = NOOP_LOG_STORE;
        if (str != null) {
            if (!CommonUtils.m143a(this.context, COLLECT_CUSTOM_LOGS, true)) {
                Fabric.m456h().mo8506a(CrashlyticsCore.TAG, "Preferences requested no custom logs. Aborting log file creation.");
            } else {
