...
public class FragmentWrapper {
    ...
    private android.support.p001v4.app.Fragment supportFragment;

    public FragmentWrapper(android.support.p001v4.app.Fragment fragment) {
    ...
    public android.support.p001v4.app.Fragment getSupportFragment() {
