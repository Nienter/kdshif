...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        this.dialog = new Dialog(getActivity(), C0750R.C0753style.com_facebook_auth_dialog);
    ...
    public View initializeContentView(boolean z) {
        ...
        if (z) {
            inflate = layoutInflater.inflate(C0750R.layout.com_facebook_smart_device_dialog_fragment, null);
        } else {
            inflate = layoutInflater.inflate(C0750R.layout.com_facebook_device_auth_dialog_fragment, null);
        }
        this.progressBar = (ProgressBar) inflate.findViewById(C0750R.C0752id.progress_bar);
        this.confirmationCode = (TextView) inflate.findViewById(C0750R.C0752id.confirmation_code);
        ((Button) inflate.findViewById(C0750R.C0752id.cancel_button)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DeviceAuthDialog.this.onCancel();
            }
        });
        ((TextView) inflate.findViewById(C0750R.C0752id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C0750R.string.com_facebook_device_auth_instructions)));
        return inflate;
    }
    ...
    public void presentConfirmation(final String str, final Utility.PermissionsPair permissionsPair, final String str2, String str3) {
        String string = getResources().getString(C0750R.string.com_facebook_smart_login_confirmation_title);
        String string2 = getResources().getString(C0750R.string.com_facebook_smart_login_confirmation_continue_as);
        String string3 = getResources().getString(C0750R.string.com_facebook_smart_login_confirmation_cancel);
    ...
    public void onSuccess(final String str) {
        ...
        new GraphRequest(new AccessToken(str, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, null, null, null, null, null), "me", bundle, HttpMethod.GET, new GraphRequest.Callback() {
            public void onCompleted(GraphResponse graphResponse) {
                if (!DeviceAuthDialog.this.completed.get()) {
                    if (graphResponse.getError() != null) {
                        DeviceAuthDialog.this.onError(graphResponse.getError().getException());
