...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0750R.styleable.com_facebook_profile_picture_view);
        setPresetSize(obtainStyledAttributes.getInt(C0750R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
        this.isCropped = obtainStyledAttributes.getBoolean(C0750R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, IS_CROPPED_DEFAULT_VALUE);
    ...
    private void setBlankProfilePicture() {
        ...
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C0750R.C0751drawable.com_facebook_profile_picture_blank_square : C0750R.C0751drawable.com_facebook_profile_picture_blank_portrait));
            return;
        }
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        switch (this.presetSizeType) {
            case LARGE /*-4*/:
                i = C0750R.dimen.com_facebook_profilepictureview_preset_size_large;
                break;
            case -3:
                i = C0750R.dimen.com_facebook_profilepictureview_preset_size_normal;
                break;
            case -2:
                i = C0750R.dimen.com_facebook_profilepictureview_preset_size_small;
                break;
            case -1:
                if (z) {
                    i = C0750R.dimen.com_facebook_profilepictureview_preset_size_normal;
