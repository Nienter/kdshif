...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(Context context, AttributeSet attributeSet, int i, int i2, String str, String str2) {
        ...
        configureButton(context, attributeSet, i, (i2 == 0 ? getDefaultStyleResource() : i2) == 0 ? C0750R.C0753style.com_facebook_button : i2 == 0 ? getDefaultStyleResource() : i2);
        ...
        if (!isInEditMode()) {
            ...
            try {
                if (obtainStyledAttributes.hasValue(0)) {
                    ...
                    setBackgroundColor(ContextCompat.getColor(context, C0750R.color.com_facebook_blue));
                }
            } finally {
