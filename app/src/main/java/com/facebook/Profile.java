...
public final class Profile implements Parcelable {
    ...
    public Uri getProfilePictureUri(int i, int i2) {
        return ImageRequest.getProfilePictureUri(this.f1718id, i, i2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f1718id.equals(profile.f1718id) || this.firstName != null) {
    ...
    public int hashCode() {
        int hashCode = this.f1718id.hashCode() + 527;
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            jSONObject.put("id", this.f1718id);
    ...
    Profile(JSONObject jSONObject) {
        Uri uri = null;
        this.f1718id = jSONObject.optString("id", null);
    ...
    private Profile(Parcel parcel) {
        this.f1718id = parcel.readString();
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f1718id);
